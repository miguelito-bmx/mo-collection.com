    ...
    <div className="min-h-screen bg-white py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-pink-600 font-semibold">A space you can trust</p>
        </div>

        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12 mb-8 border border-pink-100">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-pink-100 to-pink-50 p-6 rounded-xl border border-pink-200">
                <MapPin className="h-8 w-8 text-pink-600 mb-3" />
              ...
              <div className="bg-gradient-to-br from-pink-100 to-white p-6 rounded-xl border border-pink-200">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow border border-pink-100">
